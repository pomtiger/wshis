...
while ($row = mysqli_fetch_array($result_m)) {
  echo "<tr>";
    ...
    echo "<td><a href='member_form_del_db.php?M_ID=$row[0]' onclick=\"return confirm('คุณแน่ใจใช่หรือไม่ที่จะลบ?!! Do you want to delete this record? !!!')\" class='btn btn-danger btn-sm'>ลบ</a></td> ";
  echo "</tr>";
}
  echo "
    <tfoot>
